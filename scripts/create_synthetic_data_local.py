...
"identity_concealment": [
    ...
    "I've been observing for research purposes", "I have no affiliation with anyone here",
    "this is for a school project not personal", "you won't find my main, I protect my privacy",
    "I'm neutral in all of this I promise", "my other account is for a different community",
    "I'm just testing some things out in here", "there's a good reason I use an alt here",
    "I work adjacent to this industry, can't use my real name", "harmless curiosity nothing more",
    "I keep my identities separate for safety reasons", "I have no stake in any of this",
    "I'm just here temporarily to understand something", "don't read into who I am",
    "my profile doesn't reflect who I actually am", "I'm actually well known elsewhere",
    "I switch accounts regularly for privacy", "this is just a sock account I rarely use",
    "I'm doing field research don't mind me", "I have no connection to the drama, full stop",
    "I'd use my real account if I trusted this space", "I'm observing not participating",
    "trust what I say not who I appear to be", "I prefer to keep my identities completely separate",
],

"irony": [
    "oh wow what a surprise, didn't see that coming at all",
    "right because that makes total sense", "oh cool so now I'm the bad guy",
    "yeah I'm definitely the problem here", "sure let's all pretend that didn't happen",
    "oh I see so the rules just don't apply to everyone equally",
    "how convenient that worked out that way", "typical, works every time",
    ...
    "and that's that", "sure, totally surprised by this outcome",
    "how very strange", "another coincidence I'm sure", "right okay noted",
    "oh so suddenly the standard applies", "interesting how that rule works selectively",
    "right because you were so consistent before", "sure, I believe that completely",
    "how very surprising, totally didn't predict this",
    "of course it happened this way, no pattern whatsoever",
],

"denial": [
    "that wasn't me", "that never happened", "I don't know what you're talking about",
    "I didn't do anything wrong", "I have no idea what you mean",
    "not me must be someone else", "I was never part of that",
    "you have the wrong person", "I didn't say any of that",
    "I've never even been in that server", "prove it",
    ...
    "I was with others the whole time", "no idea what you mean",
    "I wasn't there", "I don't know them", "I played no part in this",
    "my account was probably compromised", "whoever told you that is lying",
    "I'd remember if I did that, I didn't", "you have zero proof",
    "I have a clean record here, look it up", "that post was removed before I could have seen it",
],
...
"topic_deflection": [
    ...
    "okay new subject", "honestly can we just move on",
    "I don't want to talk about this anymore", "this is pointless",
    "can we please just let this go", "this isn't the place for that discussion",
    "we have more important things to worry about", "changing the subject now",
    "honestly not worth the energy", "can we focus on something else",
    "I'm choosing to drop it", "I'm stepping away from this one",
],
...
"social_engineering": [
    ...
    "I'm not supposed to share this but you deserve to know",
    "we need your login to merge your old account with the new system",
    "you've been selected as one of our trusted beta testers",
    "this is an official security verification, don't panic",
    "the admin team needs your temporary login to fix a permissions issue",
    "we're migrating servers and you need to re-verify or lose access",
    "this link expires in five minutes, verify fast",
    "your account flagged suspicious activity, this is the appeal process",
    "only trusted members get to see this, don't share it externally",
    "if you don't respond your account gets auto-banned by tomorrow",
    "I'm not supposed to tell you this but you've been selected",
    "the founders are personally selecting members for a new opportunity",
    "this is a secure verified bot, click allow to continue",
    "your invite expires at midnight, claim it now",
    "you'll be removed from the group if you don't verify by 6pm",
    "I have a way to give you moderator status, just follow these steps",
    "the owner personally asked me to reach out to you specifically",
    "I wouldn't send you something sketchy, you know me better than that",
],

"question": [
    "can anyone help me understand this?", "what does that actually mean?",
    "is there a guide for this anywhere?", "has anyone else had this problem?",
    "what time does the event start?", "who's in charge of this?",
    "is this a known issue or just me?", "what am I missing here?",
    "can someone explain how this works?", "does anyone know the rules?",
    "how long has this been a thing?", "what rank do you need to queue?",
    "where did that rule come from?", "is there a better way to do this?",
    "what do you all recommend?", "does this work on mobile too?",
    "has anyone tried using this for that?", "who made this decision?",
    "when does the next season start?", "is the server down right now?",
    "what happened there exactly?", "how do I get access to that?",
    "is there a way to fix this without restarting?", "what's the workaround?",
    "can you walk me through the steps?", "has anyone done this before?",
    "what do you use for that?", "is there an easier method?",
    "how did you figure that out?", "where can I find the announcement?",
    "is this still the best approach?", "what changed in the latest update?",
    "is anyone else getting this error?", "what's the best way to practice?",
    "does this count towards the weekly limit?", "where do I go to appeal?",
    "how long does this usually take?", "is there a faster way?",
    "what settings do you use?", "is this intentional or a bug?",
    "can you screenshot that for me?", "what does the patch note say?",
    "is there a specific discord for this?", "how do I turn this off?",
    "does anyone know if this gets fixed?", "what's the official response?",
    "is this still active or abandoned?", "how do you deal with that?",
    "can I ask a dumb question?", "anyone else confused by this?",
],

"information_sharing": [
    "just so everyone knows, the patch drops tomorrow",
    "the official statement came out about an hour ago",
    "heads up, they changed the rules about posting that",
    "I checked and it's definitely still available until Sunday",
    "for anyone wondering, the event runs until midnight",
    "update: I fixed it, had to restart the whole thing",
    "just found out they nerfed that ability last patch",
    "the new season starts on the 15th, confirmed on their socials",
    "there's actually a workaround, I just tested it",
    "I read the patch notes, here's what actually changed",
    "fyi the maintenance is scheduled for tomorrow morning",
    "they posted a dev update about it a few hours ago",
    "I found the original post if anyone wants the full context",
    "turns out it was a known bug, they're fixing it next patch",
    "the mods clarified in an announcement earlier today",
    "I looked it up and it actually works a different way",
    "for reference, the old system was completely different",
    "I just spoke to support, they confirmed it's working as intended",
    "the wiki has been updated with the new information",
    "I can confirm from experience, it works exactly that way",
    "the tournament bracket is now up",
    "they posted the schedule this morning",
    "just to share what I found, this is really useful",
    "I've been tracking this for a while, here's what I know",
    "found the original source if you want to verify",
    "the answer is in the FAQ, page two of the pinned post",
    "quick update on what I mentioned earlier",
    "the developer replied in the thread and clarified it",
    "I've tested this on three different setups and it's consistent",
    "the community wiki has a breakdown of all the changes",
    "for those who missed it, here's a summary of what happened",
    "I confirmed with the mods, it's against the rules",
    "just verified this personally, it's still working",
    "the issue is documented in the bug tracker",
    "they mentioned it in last week's stream as well",
    "I did a bit of research and found the original reason",
    "the stats are quite different from what people think",
    "I have data on this if anyone's interested",
    "I checked and the deadline is actually next Friday, not Thursday",
    "for context, this has been happening since last month",
    "I've been in this community long enough to know this one",
    "the original announcement is still pinned in the info channel",
    "I ran the numbers and the math checks out",
    "there's a newer version that fixes the issue you're having",
    "I talked to someone who was there and here's what actually happened",
    "the full changelog is in the docs if you want to read it",
    "I can confirm from multiple sources this is accurate",
    "the system works differently than most people assume",
    "I've been following this for a while so I know the history",
    "the short version is they changed it about two updates ago",
],

"solidarity_seeking": [
    "we're all in this together", "anyone else feeling the same way?",
    "I can't be the only one who thinks this", "tell me I'm not alone in this",
    "can I get a show of hands", "am I the only one or is this a vibe",
    "solidarity from over here", "genuinely curious if others are going through this",
    "who else is feeling this right now", "I need to know I'm not alone",
    "this has to be a shared experience", "right there with you on that one",
    "I thought it was just me, glad it's not", "I feel that deeply",
    "same honestly, we're all suffering together", "you're definitely not alone",
    "I think a lot of us feel this way", "I got you on this one",
    "not just you, I promise", "speaking for myself but probably others too",
    "I know that feeling all too well", "count me in for the solidarity",
    "we've all been there honestly", "that tracks for so many of us",
    "raising my hand from across the internet", "very much a shared struggle",
    "I hear you and I'm here", "you've got people in your corner",
    "we're rooting for you", "the whole group is behind you on this",
    "none of us are alone in this room", "this community gets it",
    "we don't have to get through it alone", "I'm in your corner",
    "same energy from me", "standing with you on this one",
    "I relate to this more than I'd like to admit", "feel this in my soul",
    "every single person here has had this moment", "it's a universal thing",
    "I'm nodding along to everything you said", "me every single day",
    "the number of people who can relate to this is wild",
    "this is the most relatable thing I've read today",
    "I needed to hear someone else say this", "speak for all of us why don't you",
    "we see you and we get it", "you're among people who understand",
    "I promise you this is incredibly common", "solidarity, genuinely",
    "the collective feeling from everyone who read this is real",
    "glad someone finally said it",
],

"feedback": [
    "that was actually really helpful, thank you", "good call on that one",
    "that makes a lot of sense", "great point, hadn't thought of it that way",
    "this is exactly what I needed", "solid advice honestly",
    "I'll definitely try that", "that's a really good suggestion",
    "appreciate the detailed explanation", "this cleared things up for me",
    "you explained that perfectly", "that's the most useful thing I've heard today",
    "this helped me more than you know", "very well put",
    "I didn't know that, thanks for sharing", "that's exactly the answer I was looking for",
    "love that approach, stealing it", "that's a great way to look at it",
    "super useful, bookmarked", "really appreciate the time you took to explain",
    "that's the insight I was missing", "now it makes sense, thank you",
    "that's a really fair take", "I think you're right about that",
    "honestly that's the best explanation I've seen", "this is the answer",
    "exactly what I was looking for", "well said, I agree completely",
    "you really know what you're talking about", "thanks for clarifying",
    "this is going to save me a lot of time", "very practical advice",
    "I'll try that approach and report back", "that actually works, tested it",
    "just tried this and it fixed the issue immediately", "perfect, that's the one",
    "this is why I come to this server", "came here hoping for this exact answer",
    "that explanation was clear and simple, thank you",
    "you saved me from a lot of frustration", "much appreciated",
    "couldn't have asked for a more straightforward answer",
    "this is incredibly useful context", "thanks for the quick response",
    "that's a really balanced take", "I needed someone to lay it out like that",
    "your experience with this really shows", "legitimately one of the best answers",
    "okay that genuinely makes sense now", "I was overcomplicating it apparently",
    "I'll be using this going forward", "you gave me a lot to think about",
    "you just solved a week-long problem", "very clear, very helpful",
],
}
